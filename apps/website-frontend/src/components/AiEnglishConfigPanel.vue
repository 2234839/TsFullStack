<template>
  <div class="flex flex-col gap-4 p-4">
    ...
    <!-- 说明信息 -->
    <div
      class="text-sm text-secondary-600 dark:text-secondary-400 bg-primary-100 dark:bg-primary-800 p-3 rounded-lg"
    >
      <p class="mb-2">
        <strong>{{ t("混合模式说明：") }}</strong>
      </p>
    ...
    <div class="flex flex-col gap-3">
      <div class="flex flex-col gap-2">
        ...
        <Input v-model="config.baseURL" placeholder="https://api.openai.com/v1" class="w-full" />
      </div>
