  ...
  <div class="share-file-list flex flex-col h-full">
    ...
    <div class="flex-1 overflow-y-auto">
      <div
        ...
        :key="file.id ?? index"
        class="file-item flex items-center gap-2 px-3 py-2 cursor-pointer transition-colors text-sm"
        :class="[
        ...
        <i v-if="modifiedFileIds.has(file.id)" class="pi pi-circle text-warning-500 text-xs shrink-0" :title="t('未保存')" />
